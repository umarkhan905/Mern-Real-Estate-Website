...
const UpdateListing = () => {
  ...
  const [isPreviousListingDataFound, setIsPreviousListingDataFound] =
    useState(false);
  ...
  useEffect(() => {
    const getPreviousListingData = async () => {
      try {
        ...
        if (data.success === false) {
          ...
          setIsPreviousListingDataFound(false);
          return;
        }

        setFormData(data.data);
        setIsPreviousListingDataFound(true);
      } catch (error) {
        console.log("Error in getPreviousListingData", error);
      }
    };
    getPreviousListingData();
  }, []);
